        ...
        <!-- AdminLTE App -->
        <script src="<?php echo base_url()?>public/admin/js/AdminLTE/jquery.notifyme.min.js" type="text/javascript"></script>
