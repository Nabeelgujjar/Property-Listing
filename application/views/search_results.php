	...
	<div class="pageHeading">
		<div class="container">
			<h1>Properties for <?php echo $this->session->userdata('contract')?></h1>
		</div>
	</div>
	<!-- /.pageHeading -->
				...
				<div class="listing-column col-lg-9">
					...
					<div class="property-listing-filters clearfix">
                        ...
                        <?php $subp = $this->dbcommon->subprop() ?>
							<a href="<?php echo base_url()?>welcome/all_properties" class="active">All</a> &nbsp;
                            <?php foreach ($subp as $sub) {?> | &nbsp; <a href="<?php echo base_url()?>welcome/search_filter?sub_property=<?php echo $sub->sub_prop_id?>"><?php echo $sub->sub_prop_name?></a> <?php } ?> 
						</div>
						<div class="col-sm-3">
                        	<form method="post" id="myForm" action="<?php echo base_url()?>welcome/search_filter">
					...
					<div class="listing-page-featured">
						...
						<div id="recentCarousel" class="carousel slide clearfix">                
							...
							?>
										<div class="col-sm-4 thumbRecord"><a href="<?php echo base_url()?>welcome/view_detail/<?php echo $property->prop_id?>"><img src="<?php echo base_url()?>images/badgeFeatured.png" class="badgeFeatured"><img src="<?php echo base_url()?>images/propertyPic1.jpg" alt="Image" class="img-responsive thumb-rounded"><div class="property-price"><?php echo $price?></div><h5><?php echo $property->bedrooms?> bedroom <?php echo $subprop->sub_prop_name?> for <?php echo $type?></h5><p><?php echo $property->address?></p></a>
										</div>
                                        <?php
								if($i%3==0) {
								?>
		...
		?>
						<div class="listing-record-container clearfix">
							<div class="listing-thumb col-sm-3">
								<a href="<?php echo base_url()?>welcome/view_detail/<?php echo $prop->prop_id?>"><img src="<?php echo base_url()?>images/propertyPic1.jpg" class="img-responsive img-rounded" alt=""></a>
							</div>
							<div class="listing-features col-sm-8">
								<h4><a href="<?php echo base_url()?>welcome/view_detail/<?php echo $prop->prop_id?>"><?php echo $prop->bedrooms?> bedroom <?php echo $getsubprop->sub_prop_name ?> <?php echo $type?></a></h4>
