				...
				<div class="listing-column col-lg-9">
					...
					<div class="property-listing-filters clearfix">
                        ...
                        <?php $subp = $this->dbcommon->subprop() ?>
							<a href="<?php echo base_url()?>inex.php/welcome/all_properties" class="active">All</a> &nbsp;
		...
		?>
						<div class="listing-record-container clearfix">
							<div class="listing-thumb col-sm-3">
								<a href="<?php echo base_url()?>index.php/welcome/view_detail/<?php echo $prop->prop_id?>"><img src="<?php echo base_url()?>images/propertyPic1.jpg" class="img-responsive img-rounded" alt=""></a>
							</div>
